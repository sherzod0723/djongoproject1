...
#     count = 1
#
#     item1= input('Select menu item number ' + str(count) + ' (from 1 to 5): ')
#     item2 = input('Select menu item number ' + str(count) + ' (from 1 to 5): ')
#     item3 = input('Select menu item number ' + str(count) + ' (from 1 to 5): ')
#
#
#
# '''
